...
* Install needed libraries: Although this may not be absolutely necessary, for 32-bit R library installs, I normally navigate to the R-Portable\bin\i386 folder and then click on Rgui.exe to open RGUI. I then install any libraries using 32-bit R. 
